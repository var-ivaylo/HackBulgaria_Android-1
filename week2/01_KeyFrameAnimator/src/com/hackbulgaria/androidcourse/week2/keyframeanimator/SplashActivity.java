package com.hackbulgaria.androidcourse.week2.keyframeanimator;
...
public class SplashActivity extends Activity implements OnTouchListener, OnClickListener {
	...
	public void onClick(View v) {
		if (v == btnFrame) {
			...
			animations.add(ObjectAnimator.ofPropertyValuesHolder(image,
					translationX, translationY, scaleX, scaleY, rotation));
		} else if (v == btnPlay) {
